...
class Edge:
    ...
    @property
    def id(self) -> str:
        """Unique edge identifier string (for kb_graph_bridge compatibility)."""
        return f"{self.source_node}->{self.target_node}[{self.relation}]"
...
class GraphKB:
    ...
    def has_node(self, node_id: str) -> bool:
        """Check if a node exists (for kb_graph_bridge compatibility)."""
        return node_id in self._nodes

    def has_edge(self, source_node: str, target_node: str, relation: str = "related_to") -> bool:
        """Check if an edge exists (for kb_graph_bridge compatibility)."""
        return (source_node, target_node, relation) in self._edges
